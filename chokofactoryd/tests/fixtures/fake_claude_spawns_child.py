...
Requires `CHOKO_TEST_HEARTBEAT` (a path the grandchild writes) and
`CHOKO_TEST_CHILD_PID` (a path this process writes the grandchild's pid
...
def main():
    ...
    heartbeat = os.environ["CHOKO_TEST_HEARTBEAT"]
    child_pid_path = os.environ["CHOKO_TEST_CHILD_PID"]
